...
This project was created using web development and frameworks such as Semantic UI. The static website is hosted using Amazon S3 buckets. Also, through Amazon CloudFront to secure the website (SSL encryption). 
