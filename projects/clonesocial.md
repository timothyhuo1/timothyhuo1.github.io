...
title: Social Clone Website
permalink: projects/clone
...
labels:
  ...
  - Django
  - Python
summary: A fully functional social clone website using Django.
---

<img class="ui image" src="../images/clone-1.png">
...
After this course, I still play around and built on with this clone website. I continue to practice and change the website, such as the Django built-in admin page. This clone website introduces a helpful online website tool called [codepen.io](codepen.io/). It is a website that displays front-end code from other designers and developers. I found this to be a useful source to see what others do and gather ideas for my website. 
