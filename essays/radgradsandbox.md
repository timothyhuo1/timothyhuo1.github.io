...
For Task3, we had to create another RadGradSegment presenting MiniMongo data. In the segment, we had to display a random career goal and the number of career goals that the system has. By accessing the CareerGoals collection, I found the total careers of the user and randomized the display. 
